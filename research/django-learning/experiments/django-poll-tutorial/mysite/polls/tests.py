...
# todo:
# test if questions have choices and whether they're displayed or not
...
def create_question(question_text, days):
    """
    Create a question with the given text and published the given number of days offset to now.
